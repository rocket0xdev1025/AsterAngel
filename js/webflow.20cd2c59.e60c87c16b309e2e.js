  ...
  var e = {
      1565: function (e, t, n) {
        ...
        class s {
          ...
          destroy() {
            this.container &&
              (u.delete(this.container), l.delete(this.container)),
              this.spline?.dispose?.();
          }
          async load(e, t) {
            r || (await a());
      ...
      3946: function (e, t, n) {
        ...
        let o = n(7087),
          ...
          V = (e, t) => ({ type: _, payload: { stateKey: e, newState: t } }),
          B = (e, t) => ({ type: y, payload: { now: e, parameters: t } }),
          k = (e, t) => ({ type: O, payload: { key: e, value: t } }),
      ...
      1970: function (e, t, n) {
        ...
        function ee(e, t) {
          ...
          if (
            (er({ store: t, rawData: s, allowEvents: a, testManual: l }),
        ...
        function eE({
          ...
          let { ixInstances: o, ixSession: u } = e.getState(),
            l = u.hasBoundaryNodes && n ? I.getClosestElement(n, h) : null;
          (0, d.default)(o, (n) => {
        ...
        function ep({
          ...
          o >= p.length && (0, a.default)(f, "config.loop") && (o = 0),
            0 === o && g && o++;
          let _ =
              (0 === o || (1 === o && g)) && b(f.action?.actionTypeId)
                ? f.config.delay
                : void 0,
              ...
              p &&
                S({
                  ...
                  let p = E ? $(d)?.(s, a) : null,
                    g = E ? Q(d)(s, a) : null;
                  m = !0;
                  let y = w({ element: s, actionItem: a }),
                    O = R({ element: s, actionItem: a, elementApi: I }, p);
                  eg({
                    store: e,
                    element: s,
                    actionItem: a,
        ...
        function eg(e) {
          ...
          F({ store: n, select: ({ ixInstances: e }) => e[f], onChange: ey }),
        ...
        function ey(e, t) {
          let {
            ...
            { events: h } = b,
            { mediaQueries: C = b.mediaQueryKeys } = h && h[d] ? h[d] : {};
              ...
              handler: (
                ...
                switch (a) {
                  ...
                  case u.EventBasedOn.PAGE: {
                    ...
                    O = _ ? Math.min(e + g, n) / n : Math.min(t + I, r) / r;
                    break;
                  }
                ...
                return (
                  y && (O > 0.95 || O < 0.05) && (O = Math.round(O)),
                  (a !== u.EventBasedOn.ELEMENT ||
                    b ||
                    b !== o.elementHovered) &&
                    ((O = d ? 1 - O : O),
                    e.dispatch((0, c.parameterChanged)(T, O))),
                  {
                    elementHovered: b,
                    clientX: E,
                    clientY: p,
      ...
      4124: function (e, t, n) {
        ...
        let {
          ...
          eu = (e) => e.trim(),
          el = Object.freeze({ [en]: L, [er]: v, [ei]: M }),
          ec = Object.freeze({
        ...
        function eT({
          ...
          if (
            (S
              ? ((o = C.limitAffectedElements), (a = P), (u = d(C)))
              : (a = u = d({ id: T, selector: m, selectorGuids: h })),
            t && N)
          ) {
            let e = n && (u || !0 === N) ? [n] : f(P);
            if (u) {
        ...
        function eN(e, t = {}, n = {}, r, i) {
          ...
          switch (r.actionTypeId) {
            ...
            case Z:
              return { value: (0, o.default)(parseFloat(a(e, C)), 1) };
            case et: {
              let t,
                i = a(e, R),
                u = a(e, F);
            ...
            case eo:
              return { value: (0, o.default)(a(e, V), n.display) };
            case ea:
              ...
              return (function (e, t, n, r, i, o) {
                ...
                switch (r.actionTypeId) {
                  case et: {
                    ...
                    void 0 !== a &&
                      (t === k && (t = "px"), ek(e, R, o), u(e, R, a + t)),
                      void 0 !== l &&
                        (i === k && (i = "px"), ek(e, F, o), u(e, F, l + i));
                    break;
                  }
                  case J:
                    var l = r.config;
            ...
            switch (t.type) {
              ...
              case O: {
                let {
                  ...
                  c = e;
                return (
                  (0, o.getIn)(c, [n, r]) !== r && (c = h(c, r, u, n, a)),
                  A(c, n, l, i, a)
                );
              }
              case T: {
                      ...
                      actionItems: [
                        {
                          ...
                          config: {
                            ...
                            target: {
                              pluginElement:
                                "1584a001-0fd7-31d9-1a06-cdb84b4d90da",
                              objectId: "6bf7f235-e80a-4cc0-96aa-ea9ef0e8dd26",
                              selector: ".spline-scene",
                              selectorGuids: [
                                "87e90868-189d-4d9d-ee0a-dd4f73766b83",
                              ],
                            },
                            value: {
                              positionY: null,
    ...
    (() => {
      ...
      n.O = (t, r, i, o) => {
        ...
        for (var u = 1 / 0, a = 0; a < e.length; a++) {
          for (var [r, i, o] = e[a], l = !0, c = 0; c < r.length; c++)
            (!1 & o || u >= o) && Object.keys(n.O).every((e) => n.O[e](r[c]))
              ? r.splice(c--, 1)
              : ((l = !1), o < u && (u = o));
          if (l) {
            e.splice(a--, 1);
